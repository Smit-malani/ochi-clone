...
function Footer() {
  return (
    <div data-scroll data-scroll-speed="1.8" className='w-full bg-[#f1f1f1] flex items-center overflow-y-hidden -mt-96 px-12'>
        <div className='w-1/2 min-h-[100vh] flex flex-col justify-between'>
            <h1 className='text-[9vw] leading-[8vw] font-bold uppercase tracking-tighter'>eye-opening</h1>
            <div className='logo'>
        ...
        <div className='w-1/2 min-h-[100vh] flex flex-col items-start gap-8'>
            <div className='text-[6vw] leading-[8vw] font-bold uppercase tracking-tighter'>presentations</div>
            <div className='capitalize'>
              <p className='mb-3  text-[#212121]'>S:</p>
              <ul>
                <li className='underline text-[#212121]'>instagram</li>
                <li className='underline text-[#212121]'>Behance</li>
                <li className='underline text-[#212121]'>Facebook</li>
                <li className='underline text-[#212121]'>Linkedin</li>
              </ul>
            </div>
            <div className='flex items-center  text-[#212121] capitalize justify-between w-full'>
                <div>
                    <p className='mb-3'>L:</p>
                    <ul>
                        <li className='underline'>202-1965 W 4th Ave</li>
                        <li className='underline mb-6'>Vancouver, Canada</li>
                ...
                <div>
                    ...
                    <ul>
                        ...
                        <li className='underline'>Our work</li>
                        <li className='underline'>About us</li>
                        <li className='underline'>Insights</li>
            ...
            <div className=' text-[#212121]'>
              ...
              <ul>
                <li className='underline'>hello@ochi.design</li>
              </ul>
            </div>
            <div className='flex items-center text-zinc-300 justify-between w-full'>
                <div>
